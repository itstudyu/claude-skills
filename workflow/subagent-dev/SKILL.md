...
digraph when_to_use {
    ...
    "subagent-dev" [shape=box];
    "execute-plan" [shape=box];
    "Manual execution or define spec first" [shape=box];

    "Have implementation plan?" -> "Tasks mostly independent?" [label="yes"];
    "Have implementation plan?" -> "Manual execution or define spec first" [label="no"];
    "Tasks mostly independent?" -> "Stay in this session?" [label="yes"];
    "Tasks mostly independent?" -> "Manual execution or define spec first" [label="no - tightly coupled"];
    "Stay in this session?" -> "subagent-dev" [label="yes"];
...
digraph process {
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Complete development";
}
```
...
When you have multiple independent tasks or failures that don't share state, dispatch agents in parallel instead of sequentially.
...
### Parallel Agent Prompt Structure
...
### Common Mistakes with Parallel Dispatch
...
### Verification After Parallel Agents
