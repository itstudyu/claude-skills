...
If `NEEDS_SETUP`:
1. Tell the user: "claude-skills browse needs a one-time build (~10 seconds). OK to proceed?" Then STOP and wait.
...
```bash
REPORT_DIR=".claude-skills/design-reports"
...
**Local:** `.claude-skills/design-reports/design-audit-{domain}-{YYYY-MM-DD}.md`
