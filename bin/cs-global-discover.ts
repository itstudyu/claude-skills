#!/usr/bin/env bun
/**
 * cs-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   cs-global-discover --since 7d [--format json|summary]
 *   cs-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: cs-global-discover --since <window> [--format json|summary]
...
Examples:
  cs-global-discover --since 7d
  cs-global-discover --since 14d --format summary`);
}
